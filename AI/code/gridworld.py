...
def TaskGridWorld_1():
    ...
    i = 0
    while i < 12:
        env.types.append((0, i, 1))
        env.types.append((11, i, 1))
        env.types.append((i, 0, 1))
        env.types.append((i, 11, 1))
        i = i + 1
...
def TaskGridWorld_2():
    ...
    env.ends = [(19, 20)]
    i = 0
    env.types = [(4, 1, 1), (5, 1, 1), (9, 1, 1), (15, 1, 1),
                 (2, 2, 1), (9, 2, 1), (11, 2, 1), (13, 2, 1), (14, 2, 1), (17, 2, 1), (18, 2, 1),
                 (3, 3, 1), (4, 3, 1), (9, 3, 1), (12, 3, 1), (19, 3, 1),
                 (6, 4, 1), (8, 4, 1), (9, 4, 1), (13, 4, 1), (14, 4, 1), (18, 4, 1), (20, 4, 1),
                 (3, 5, 1), (6, 5, 1), (7, 5, 1), (8, 5, 1), (11, 5, 1), (14, 5, 1), (17, 5, 1),
                 (2, 6, 1), (4, 6, 1), (8, 6, 1), (11, 6, 1), (19, 6, 1),
                 (4, 7, 1), (5, 7, 1), (6, 7, 1), (11, 7, 1), (12, 7, 1), (13, 7, 1), (19, 7, 1),
                 (1, 8, 1), (4, 8, 1), (9, 8, 1), (13, 8, 1), (16, 8, 1), (17, 8, 1), (18, 8, 1), (19, 8, 1),
                 (4, 9, 1), (5, 9, 1), (8, 9, 1), (9, 9, 1), (11, 9, 1), (13, 9, 1), (18, 9, 1),
                 (3, 10, 1), (4, 10, 1), (8, 10, 1), (11, 10, 1), (16, 10, 1), (17, 10, 1), (18, 10, 1), (20, 10, 1),
                 (8, 11, 1), (9, 11, 1), (10, 11, 1), (11, 11, 1), (12, 11, 1), (13, 11, 1), (20, 11, 1),
                 (1, 12, 1), (8, 12, 1), (12, 12, 1), (16, 12, 1), (17, 12, 1), (19, 12, 1), (20, 12, 1),
                 (3, 13, 1), (5, 13, 1), (6, 13, 1), (7, 13, 1), (8, 13, 1), (11, 13, 1), (12, 13, 1),
                 (2, 14, 1), (3, 14, 1), (7, 14, 1), (12, 14, 1), (13, 14, 1), (14, 14, 1), (15, 14, 1), (16, 14, 1),
                 (17, 14, 1), (18,14,1), (20, 14, 1),
                 (1, 15, 1), (2, 15, 1), (3, 15, 1), (4, 15, 1), (6, 15, 1), (7, 15, 1), (9, 15, 1), (12, 15, 1),
                 (20, 15, 1),
                 (1, 16, 1), (9, 16, 1), (11, 16, 1), (14, 16, 1), (15, 16, 1), (16, 16, 1), (17, 16, 1), (18, 16, 1),
                 (20, 16, 1),
                 (1, 17, 1), (5, 17, 1), (6, 17, 1), (7, 17, 1), (9, 17, 1), (11, 17, 1), (14, 17, 1),
                 (4, 18, 1), (5, 18, 1), (6, 18, 1), (8, 18, 1), (13, 18, 1), (14, 18, 1), (16, 18, 1), (17, 18, 1),
                 (5, 19, 1), (8, 19, 1), (10, 19, 1), (18, 19, 1),
                 (8, 20, 1), (9, 20, 1), (10, 20, 1), (13, 20, 1), (17, 20, 1), (18, 20, 1)
                 ]
    while i < 22:
        env.types.append((0, i, 1))
        env.types.append((21, i, 1))
        env.types.append((i, 0, 1))
        env.types.append((i, 21, 1))
        i = i + 1

    env.rewards = [(19, 20, 10)]
    env.refresh_setting()
    return env